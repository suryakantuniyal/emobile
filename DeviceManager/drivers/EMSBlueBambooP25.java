...
//	}
	...
	public boolean printTransaction(String ordID, int type, boolean isFromHistory, boolean fromOnHold) {
		...
		// payArrayList.get(0)[5], LINE_WIDTH, 2));
		// }
		...
		// this.printBambooImage(1);
		// sb.setLength(0);
		// sb.append(textHandler.centeredString("x" +
		// textHandler.lines(LINE_WIDTH / 2), LINE_WIDTH));
		// sb.append(textHandler.centeredString(getString(R.string.receipt_signature),
		// LINE_WIDTH));
		// this.printString(sb.toString());
		...
		//
		// if (isFromHistory) {
		// this.printString(textHandler.centeredString("*** Copy ***",
		// LINE_WIDTH));
		// this.printString(textHandler.newLines(4));
		// }

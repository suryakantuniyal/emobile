...
public class RoverCallStateService extends Service {

	public static final String INTENT_ACTION_INCOMING_CALL = "net.homeatm.rover.INCOMING_CALL";
	...
	private static final String LOG_TAG = RoverCallStateService.class.getName();

...
//        builder.appendCodePage(CodePageType.Blank); builder.append("*Blank*\n".getBytes());
    ...
    public static byte[] createBitmapData(Emulation emulation, int width, Context context, int resId) {
        Bitmap sphereImage   = BitmapFactory.decodeResource(context.getResources(), resId);
        Bitmap starLogoImage = BitmapFactory.decodeResource(context.getResources(), resId);

...
class ItemListAdapter extends ArrayAdapter<ItemList> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        for (TextInfo textInfo : textList) {
            TextView textView = (TextView) convertView.findViewById( textInfo.getTextResourceID() );
        ...
        if (switchList != null) {
            for (SwitchInfo switchInfo : switchList) {
                Switch switchView = (Switch) convertView.findViewById(switchInfo.getResourceID());
        ...
        if (imgList != null) {
            for (ImgInfo imgInfo : imgList) {
                ImageView imageView = (ImageView) convertView.findViewById(imgInfo.getResourceID());
...
class ItemList {
    ...
    ItemList(int layoutResourceID, List<TextInfo> textList, List<SwitchInfo> switchList, int backGroundColor, boolean isClickable) {
        this.mLayoutResourceID        = layoutResourceID;
        this.mTextList                = textList;

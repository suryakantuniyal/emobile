...
public class EMSIDTechUSB {
	...
	private int _productId = Integer.parseInt("2010", 16);
	private int _vendorId = Integer.parseInt("0ACD", 16);
							...
							_activity.runOnUiThread(new Runnable() {
							     ...
							     public void run() {
							    	 if(arrayOfByte.length>3&&checkLRCAndChecksum(arrayOfByte))
							    		 _callBack.cardWasReadSuccessfully(true, EMSUniMagDriver.parseCardData(_activity,arrayOfByte));
							    	 else

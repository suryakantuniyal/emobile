...
public class CardData {
	...
	public String getT1Encrypted()
	{
		...
		return stringData.substring(startIndex, startIndex+lengthOfTR1EncryptedSection()*2);
		}
		else
			return null;
	}
	public String getT1DataAscii() {
		...
		for (int i=10; i<getTrack1Length()+9; i++){
			sf.append((char)byteData[i]);
		}
		return sf.toString();
	}
	...
	public String getT2Encrypted()
	{
		...
		if (isT2DataPresent())
			startIndex += getTrack2Length()*2;
		startIndex+=lengthOfTR1EncryptedSection()*2;

		return stringData.substring(startIndex,startIndex+lengthOfTR2EncryptedSection()*2);
		}
		else
			return null;
	}
	...
	public String getT2DataAscii() {
		...
		if (!isT2DataPresent())
			return "";
		for (int i=getTrack1Length()+10; i<getTrack1Length()+9+getTrack2Length(); i++){
			sf.append((char)byteData[i]);
		}
		return sf.toString();
	}	
	...
	private int lengthOfTR1EncryptedSection()
	{
		if (!isDataEncrypted())
			return 0;
	...
	private int lengthOfTR2EncryptedSection()
	{
		if (!isDataEncrypted())
			return 0;
	...
	public String toString() {
		...
		if (isDataEncrypted()) {
			...
			sb.append("Encryption Type: ").append(encryptionType).append("\n");
			sb.append("STX: ").append(getSTX()).append("\n");
			sb.append("Data Length: ").append(getDataLength()).append("\n");
			sb.append("Card Encode Type: ").append(getCardEncodeType()).append("\n");
			sb.append("Track 1-3 Status: ").append(getTrackStatus()).append("\n");
			//sb.append("Track 1 Data Length: ").append()
			...
			return  "Encryption Type: "+encryptionType + "\n" +
					...
					"Track 1 Encrypted: " + getT1Encrypted()+"\n\n"+
					"Track 2 Encrypted: " + getT2Encrypted()+"\n\n"+

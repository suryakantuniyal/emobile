...
public String generateIVULoto()
{
	StringBuilder sb = new StringBuilder();
	sb.append(this.converttobase34(this.nextInt(45435423), 34)).append("-").append(this.converttobase34(this.nextInt(45435423), 34));
	return sb.toString();
}

public String converttobase34(int num, int nbase)
{
    String charset = "0123456789ABCDEFGHJKLMNPQRSTUVWXYZ";
    if (nbase < 2 || nbase > charset.length())
        return "";
    ...
    {
        r = num % nbase;
        //newNumber = charset[r] + newNumber;
        sb.append(charset.substring(r, r+1));
        num = num / nbase;
    }
    //add last number
    sb.append(charset.substring(num, num+1));
    
    
    int size = sb.toString().length();
    newNumber = sb.toString();
    
    //validate if all 5 numbers were generated
    if(size<5)
    {
    	...
    	newNumber = sb2.append(newNumber).toString();
    }

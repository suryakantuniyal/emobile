...
public class TaxesHandler {
	...
	private final String tax_name = "tax_name";
	private final String tax_code_id = "tax_code_id";
	private final String tax_code_name = "tax_code_name";
	private final String tax_rate = "tax_rate";
	private final String tax_type = "tax_type";
	private final String isactive = "isactive";
	private final String tax_update = "tax_update";
	private final String prTax = "prTax";
	private final String tax_default = "tax_default";
	private final String tax_account = "tax_account";

	private final List<String> attr = Arrays.asList(new String[] { tax_id_key, tax_id, tax_name, tax_code_id, tax_code_name, tax_rate, tax_type,
...
//			tracker.send(MapBuilder.createException(sb.toString(), false).build());
	...
	public List<GroupTaxRate> getGroupTaxRate(String taxGroupId)
	{
		...
		sb.append(taxGroupId).append("' ORDER BY t.tax_name ASC");

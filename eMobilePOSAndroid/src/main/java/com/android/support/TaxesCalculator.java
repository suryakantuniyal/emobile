...
public class TaxesCalculator {
    ...
    private final OrderProducts orderProduct;
    ...
    public TaxesCalculator(Activity activity, MyPreferences myPref, OrderProducts orderProduct, String taxID, int taxSelected, int discountSelected, BigDecimal discountable_sub_total, BigDecimal itemsDiscountTotal, List<HashMap<String, String>> listMapTaxes) {

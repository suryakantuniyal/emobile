            ...
            if (holder.addonButton != null) {
                ...
                for (OrderProduct orderProduct : product.addonsProducts) {
                    if (orderProduct.isAdded()) {
                        addonSb.append(" <font color='black'>").append(orderProduct.ordprod_name).append("</font>");
                        addonSb.append(", ");
                    } else {
                        addonNoSb.append(" <font color='red'>").append(activity.getString(R.string.button_no)).append(" ").append(orderProduct.ordprod_name).append("</font>");
                        addonNoSb.append(", ");
                    }
                    i++;
                }

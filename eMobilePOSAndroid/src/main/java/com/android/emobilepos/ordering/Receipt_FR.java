...
public class Receipt_FR extends Fragment implements OnClickListener,
                    ...
                    if (custSelected) // is Order
                    {
                        ...
                        if (myPref
                            ...
                            if (myPref
                                ...
                                new PrintAsync(orderingAction).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, false);
                            } else
                                showPrintDlg(false);
                        } else {
    ...
    private void processConsignment() {
        ...
        switch (consignmentType) {
            case ORDER:// Rack
                ...
                Global.consignment_qtyCounter = OrderProductUtils.getProductQtyHashMap(getOrderingMainFa().global.order.getOrderProducts());
            ...
            case CONSIGNMENT_RETURN:// Returns
                ...
                Global.cons_return_qtyCounter = OrderProductUtils.getProductQtyHashMap(getOrderingMainFa().global.order.getOrderProducts());
            ...
            case CONSIGNMENT_FILLUP:// Fill-up
                ...
                Global.cons_fillup_qtyCounter = OrderProductUtils.getProductQtyHashMap(getOrderingMainFa().global.order.getOrderProducts());
    ...
    private void setOrderAsHold(String holdName, OrdersHandler ordersHandler, OrderProductsHandler orderProductsHandler) {
        ...
        orderProductsHandler.deleteAllOrdProd(getOrderingMainFa().global.order.ord_id);
        orderProductsHandler.insert(getOrderingMainFa().global.order.getOrderProducts());
        new PrintAsync(OrderingMain_FA.OrderingAction.HOLD).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, true);
    ...
    private void showPrintDlg(boolean isRetry) {
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dlog.dismiss();
                new PrintAsync(OrderingMain_FA.OrderingAction.NONE).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, false);

...
public class Clerk extends RealmObject {
    ...
    public boolean isIsUnenryptedSwipeAllowed() {
        return isUnenryptedSwipeAllowed;
    }

    public void setIsUnenryptedSwipeAllowed(boolean isUnenryptedSwipeAllowed) {
        this.isUnenryptedSwipeAllowed = isUnenryptedSwipeAllowed;
    }

...
*/
    ...
    public VehicleList(String deviceName,int deviceId){
...
//        this.deviceId= deviceId;
    ...
    public VehicleList(int id, String name, String uniqueId, String status, String lastUpdates, String category, int positionId, String address, String time, Double speed,
                       Double latitute, Double longitute,String timeDiff,int groupid) {
        this.id = id;
        this.name = name;
        this.uniqueId = uniqueId;
        this.status = status;

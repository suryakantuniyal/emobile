package com.innobins.innotrack.unknownActivity;
...
public class UnknownActivity extends BaseActivity implements VehicleslistAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    // private static final String TAG = "MainActivity";

    private static final String TAG = "UnknownActivity";
    public static UnknownActivity instance;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pintent = PendingIntent.getService(UnknownActivity.this, 0, updateListViewService, 0);
    ...
    public void uploadNewData() {
        ...
        try {
            ...
            WebserviceHelper.getInstance().PostCall(UnknownActivity.this, mUrl, jsonObject, new ResponseCallback() {
                @Override
    ...
    public void OnItemClick(View view, int position, List<VehicleList> mFilteredList) {
        ...
        if (view.getId() == R.id.detail_ll) {
            ...
            Intent intent = new Intent(UnknownActivity.this, VehicleOnMap.class);
            ...
            Intent trackIntent = new Intent(UnknownActivity.this, TrackingDevicesActivity.class);
    ...
    private List<VehicleList> parseView() {
        ...
        try {
            ...
            JSONArray vehicleList = previousData.getJSONArray("UnknownList");
            Log.d("UnknownList", String.valueOf(vehicleList));
            progressDialog.dismiss();
            swipeRefreshLayout.setRefreshing(false);

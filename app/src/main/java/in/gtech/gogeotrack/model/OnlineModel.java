...
public class OnlineModel {
    ...
    public OnlineModel(int id, String name, String uniqueId, String status, String lastUpdates, String category, int positionId, String address, String time, String timeDiff) {
        this.id = id;
        this.name = name;

...
public class SynchMethods 
{
	...
	public SynchMethods(DBManager managerInst) 
	{
		...
		try {
			...
			sb.append(e.getMessage()).append(" [com.android.support.SynchMethods (at Class.SynchMethods) ]");
...
//			{
				...
				else if(downloadHoldList&&!isError)
				{
	...
	private void synchAccountLogo(resynchAsync task)
	{
		...
		try {
			...
			// TODO Auto-generated catch block
			StringBuilder sb = new StringBuilder();
			sb.append(e.getMessage()).append(" [com.android.support.SynchMethods (at Class.syncAccountLogo)]");
			handleGoogleAnalytic (sb.toString());
		} catch (IOException e) {
			// TODO Auto-generated catch block
			StringBuilder sb = new StringBuilder();
			sb.append(e.getMessage()).append(" [com.android.support.SynchMethods (at Class.synchAccountLogo)]");
			handleGoogleAnalytic (sb.toString());
		}
		catch(Exception e)
		{
	...
	private void synchEmployeeData(resynchAsync task) throws IOException,SAXException
	{
		...
		try {
			...
			// TODO Auto-generated catch block
			StringBuilder sb = new StringBuilder();
			sb.append(e.getMessage()).append(" [com.android.support.SynchMethods (at Class.synchEmployeeData)]");
			handleGoogleAnalytic (sb.toString());
		}
		data.clear();
	}
	...
	private void synchDownloadLastPayID(resynchAsync task) 
	{
		...
		try {
			...
			// TODO Auto-generated catch block
			StringBuilder sb = new StringBuilder();
			sb.append(e.getMessage()).append(" [com.android.support.SynchMethods (at Class.synchDownloadLastPayID)]");
			handleGoogleAnalytic (sb.toString());
		}
	}

...
public class SalesMenuAdapter extends BaseAdapter implements Filterable {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		int gradientId = activity.getResources().getIdentifier("blue_btn_selector", "drawable", activity.getString(R.string.pkg_name));
		String resourceName = mainMenuIconsMap.get(indexOfEnabled.get(position));
		int iconId = activity.getResources().getIdentifier(resourceName, "drawable", activity.getString(R.string.pkg_name));

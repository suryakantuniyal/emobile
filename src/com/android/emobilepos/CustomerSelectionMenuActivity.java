...
public class CustomerSelectionMenuActivity extends Activity implements OnClickListener{
	...
	private CustomerSelectionMenuActivity _thisActivity;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		myCursor = handler.getCursorAllCust(db);
		...
		{
		addNewCust.setOnClickListener(new View.OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(thisContext, AddNewCustFragmentActivity.class);
...
//					View dialogLayout = inflater.inflate(R.layout.custselec_dialog_layout, null);
//					final AlertDialog.Builder builder = new AlertDialog.Builder(arg0.getContext());
//					builder.setView(dialogLayout);
//	
//					final AlertDialog dialog = builder.create();
//					Button selecCust = (Button) dialogLayout.findViewById(R.id.selectCustBut);
//					Button dialPhone = (Button) dialogLayout.findViewById(R.id.dialBut);
//					Button mapView = (Button) dialogLayout.findViewById(R.id.mapBut);
//					Button viewTrans = (Button) dialogLayout.findViewById(R.id.viewTransBut);
//	
//					Button cancel = (Button) dialogLayout.findViewById(R.id.cancelBut);
//					selecCust.setOnClickListener(new Button.OnClickListener() {
//	
//						@Override
//						public void onClick(View v) {
//							// TODO Auto-generated method stub
...
//						public void onClick(View v) {
//							// TODO Auto-generated method stub
//							Intent intent = new Intent(activity, TransactionsMenuActivity.class);
...
//					dialog.show();
	...
	private void selectCustomer(int itemIndex)
	{
		...
		if(taxHandler.checkIfCustTaxable(myCursor.getString(myCursor.getColumnIndex("cust_taxable"))))
	...
	public void performSearch(String text) {
		if (myCursor != null)
			myCursor.close();
		myCursor = handler.getSearchCust(db,text);
		adap2 = new CustomCursorAdapter(thisContext, myCursor, CursorAdapter.NO_SELECTION);
		myListView.setAdapter(adap2);
	...
	public class CustomCursorAdapter extends CursorAdapter {
		...
		public void bindView(View view, Context context, Cursor cursor) {
			...
			/*TextView customerName = (TextView) view.findViewById(R.id.custSelecName);
			customerName.setText(cursor.getString(cursor.getColumnIndex("cust_name")));

			ImageView moreInfoIcon = (ImageView) view.findViewById(R.id.custSelecIcon);
			final String custID = cursor.getString(cursor.getColumnIndex("_id"));
			moreInfoIcon.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent intent = new Intent(thisContext, CustomerMoreDetailsActivity.class);
			...
			holder.moreInfoIcon.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent intent = new Intent(thisContext, CustomerMoreDetailsActivity.class);
					intent.putExtra("cust_id", holder.cust_id.getText().toString());
					startActivity(intent);
				}
			});
		...
		private class ViewHolder
		{
			...
			int i_cust_id,i_cust_name,i_CompanyName,i_cust_phone,i_pricelevel_name;
		}

...
public class CustomerMoreDetailsActivity extends Activity {
	private ListViewAdapter myAdapter;

	private  List<String> allInfoLeft;// = Arrays.asList(new String[] { "Name", "Contact", "Phone", "e-Mail", "Company" });
	...
	//private List<String> allAddressRight = new ArrayList<String>();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		data = custHandler.getCustDetails(myDB, cust_id);
		int size = data.size();
	...
	public class ListViewAdapter extends BaseAdapter implements Filterable {
		...
		public int getCount() {
			// TODO Auto-generated method stub
			return allInfoLeft.size() + allFinancialLeft.size() + 3 + 2; // +3
																			// for
																			// the
																			// dividers
																			// and
			...
			if (convertView == null) {
				...
				case 1: {
					...
					else if(position==allFinancialLeft.size() + allInfoLeft.size() + 3)				//Billing Address
					{
						...
						//int index = allAddressRight.size();
						//index = position-(length2+1);

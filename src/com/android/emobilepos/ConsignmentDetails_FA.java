...
import com.android.emobilepos.history.details.ConsignmentDetails_Adapter;
import com.android.support.Global;

public class ConsignmentDetails_FA extends FragmentActivity implements OnClickListener{
	
	private StickyListHeadersListView lView;
	private ConsignmentDetails_Adapter adapter;
	private Cursor c;
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		adapter = new ConsignmentDetails_Adapter(this,c,dataMap,extras.getBoolean("isPickup"));

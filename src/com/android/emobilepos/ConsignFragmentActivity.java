...
public class ConsignFragmentActivity extends FragmentActivity 
{
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) 
	{
		if (resultCode == 1) 
		{
//			ConsignMainFragment fragment = (ConsignMainFragment) getSupportFragmentManager().findFragmentByTag("Consign");
//			if(fragment!=null)
//			{

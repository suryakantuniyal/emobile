...
public class OrderAttrEdit_FA extends FragmentActivity implements OnClickListener, OnCheckedChangeListener,EMSCallBack {
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		Global.isEncryptSwipe = false;		//will not encrypt number of card after swipe
		...
		fieldHiddenSwiper.addTextChangedListener(textWatcherSwiper(fieldHiddenSwiper));
	...
	private void setUpIfModify()
	{
		if(isModify)
		{
			...
			{
				if(global.ordProdAttr.get(i).ordprod_id.equals(ordprod_id)&&global.ordProdAttr.get(i).Attrid.equals(attr_id))
				{
					modifyPosition = i;

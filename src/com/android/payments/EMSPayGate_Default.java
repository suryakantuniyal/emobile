...
public class EMSPayGate_Default 
{
	...
	private enum EAction {
		ChargeCreditCardAction(1010),
		ChargeTupixAction(1010),
		ChargeCheckAction(1012), 
		ChargeCashAction(1013), 
		ChargeDebitAction(1014), 
		
		ChargeGeniusAction(1017),
		ChargeGiftCardAction(1018),
		ChargeLoyaltyCardAction(1019),
		CreditCardAuthAction(1020),
		ChargeRewardAction(1021),
		
		VoidCreditCardAction(2010),
		VoidCheckAction(2012),
		ReturnCreditCardAction(3010),
		ReturnDebitAction(3014),
		
		
		ReturnGeniusAction(3017),
		VoidGiftCardAction (2018),
		ReturnGiftCardAction(3018),
		ActivateGiftCardAction(5000),
		DeactivateGiftCardAction(5010),
		AddValueGiftCardAction(5010),
		BalanceGiftCardAction(5020),
		
		ActivateLoyaltyCardAction(6000),
		AddValueLoyaltyCardAction(6010),
		BalanceLoyaltyCardAction(6020),
		
		ActivateRewardAction(6100),
		AddValueRewardAction(6110),
		BalanceRewardAction(6120),
		
		CheckTransactionStatus(7003),
		
		GiftCardReverseAction(9995),
		LoyaltyCardReverseAction(9996),
		RewardCardReverseAction(9997),
		ReverseCheckAction(9992),
		ReverseCreditCardAction(9993),
		ReverseDebitCardAction(9994),
		
		
		
		ProcessBoloroCheckout(10000),
		CancelBoloroTransaction(10001),
		GetTelcoInfoByTag(10002),
		GetMarketTelcos(10003),
		BoloroPolling(10004);
...
//					break;
	...
	private void generateCardBlock(String card_name,boolean isSwipe) throws IllegalArgumentException, IllegalStateException, IOException
	{
	...
	private void generateERP() throws IllegalArgumentException, IllegalStateException, IOException
	{
		...
		if(value!=null&&!value.isEmpty()&&(!myPref.getShiftIsOpen()||myPref.getPreferences(MyPreferences.pref_use_clerks)))
		{
	...
	private void generateContactInfoBlock(String cust_id) throws IllegalArgumentException, IllegalStateException, IOException
	{

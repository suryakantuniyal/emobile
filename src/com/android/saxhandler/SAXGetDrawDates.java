...
import com.android.saxhandler.SAXGetTemplates.Limiters;
import com.android.support.Global;

public class SAXGetDrawDates extends DefaultHandler 
{
	...
	private DrawInfoHandler drawDateHandler;
	...
	public SAXGetDrawDates(Activity activity,SQLiteDatabase db) {
		...
		drawDateHandler = new DrawInfoHandler(activity);
	}
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		if (test != null) {
			...
			case Table: {
				...
				drawDateHandler.insert(this.db, list_data, temp_data);

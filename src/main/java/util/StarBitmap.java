...
public class StarBitmap
{
	...
	public StarBitmap(Bitmap picture, boolean supportDithering, int maxWidth,int testWidth)
	{
		PAPER_WIDTH = testWidth;
		...
		else
		{
			...
			for(int y=0;y < height; y++)
			{
				for(int x=0;x<width; x++)
				{
					...
					if(picture.getPixel(x, y)==Color.TRANSPARENT)
...
//		Byte[] beginingBytes = {0x1b, 0x40, 0x1b, 0x58, 0x32, 0x18};
		Byte[] beginingBytes = {0x1b, 0x40,    // ESC @
				                ...
				                (byte) ((PAPER_WIDTH/2-mWidth/2)), 0x00, 0x00, 0x00,
				                (byte) (mWidth % 256), (byte) (mWidth / 256),
				                (byte) ((height+15) % 256), (byte) ((height+15) / 256),
				                0x1b, 0x58, 0x32, 0x18};    // ESC X 2 n
		
		/*
		 				        (byte) ((406 % 256)-mWidth/4), 0x00, 0x00, 0x00,
				                (byte) (mWidth % 256), (byte) (mWidth),
				                (byte) ((height) % 100), (byte) ((height/400)),
		 */
